...
class DashController extends Controller
{
    ...
    {
        return sprintf(
            '%d created, %d moved, %d retitled, %d alt-synced, %d resized, %d content-changed, %d trashed%s%s%s%s%s%s%s%s%s',
            $counts['created'],
            $counts['moved'],
            $counts['retitled'],
            $counts['altSynced'],
            ...
            $counts['restamped'],
            $counts['trashed'],
            $counts['reframed'] > 0 ? ", {$counts['reframed']} FOCAL POINT(S) TO RE-CHECK" : '',
