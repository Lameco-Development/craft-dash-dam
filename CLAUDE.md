...
- CI (`.github/workflows/ci.yml`) runs ECS and PHPStan on PHP 8.2 and 8.4, on PRs and pushes to `main`. The `tests` job is wired but disabled until the test suite lands (issue #6).
